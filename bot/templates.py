...
_HUD_DEFAULTS = {
    ...
    "team_points":     (560,  213, 200,  77),
    "team_bonus":      (420,  200, 145,  80),
    ...
    "slot_hp":         (210,  685, 148,  50),  # ♥ HP value (digits only, no icon)
    "slot_atk":        (408,  685, 173,  50),  # ⚔ Attack value (digits only, no icon)
